...
extern EIF_TYPED_VALUE F354_1561(EIF_REFERENCE);
extern EIF_TYPED_VALUE F354_1562(EIF_REFERENCE);
extern EIF_TYPED_VALUE F354_1563(EIF_REFERENCE);
extern EIF_TYPED_VALUE F354_1564(EIF_REFERENCE);
extern void F354_1565(EIF_REFERENCE);
extern void F354_5518(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F354_1561 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F354_1562 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F354_1563 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 353, Current, 0, 0, 1932);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(353, Current, 1932);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F354_1564 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 353, Current, 0, 0, 1933);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(353, Current, 1933);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F354_1565 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 353, Current, 0, 0, 1934);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(353, Current, 1934);
	RTIV(Current, RTAL);
...
body:;
	if (RTAL & CK_ENSURE) {
		...
		RTE_OE
		RTE_OT
		ti4_3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1397, dtype))(Current)).it_i4);
		ti4_2 = ti4_3;
		tr2 = NULL;
		RTE_O
		tr2 = RTLA;
...
void F354_5518 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 353, Current, 0, 5517);
	RTSA(dtype);
	RTME(dtype, 0);
