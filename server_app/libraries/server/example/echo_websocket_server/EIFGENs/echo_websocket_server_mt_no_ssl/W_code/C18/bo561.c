...
extern EIF_TYPED_VALUE F561_1559(EIF_REFERENCE);
extern void F561_5517(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F561_1559 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 560, Current, 0, 0, 1907);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
/* {BOUNDED}._invariant */
void F561_5517 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 560, Current, 0, 5516);
	RTSA(dtype);
	RTME(dtype, 0);
