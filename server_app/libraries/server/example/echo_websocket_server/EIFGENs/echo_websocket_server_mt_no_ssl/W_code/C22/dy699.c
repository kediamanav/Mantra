...
extern EIF_TYPED_VALUE F699_3131(EIF_REFERENCE);
extern EIF_TYPED_VALUE F699_3132(EIF_REFERENCE);
extern void F699_3138(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F699_3141(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F699_3142(EIF_REFERENCE);
extern EIF_TYPED_VALUE F699_3143(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F699_3131 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 698, Current, 0, 0, 5489);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(698, Current, 5489);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F699_3132 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 698, Current, 0, 0, 5490);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(698, Current, 5490);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {DYNAMIC_CHAIN}.prune */
void F699_3138 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 698, Current, 0, 1, 5491);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(698, Current, 5491);
	RTIV(Current, RTAL);
...
void F699_3141 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 698, Current, 0, 1, 5492);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(698, Current, 5492);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F699_3142 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 698, Current, 0, 0, 5493);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(698, Current, 5493);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F699_3143 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 698, Current, 2, 1, 5494);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(698, Current, 5494);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	for (;;) {
		...
		ub1 = tb2;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(1405, "extend", Result))(Result, ub1x);
		RTHOOK(9);
