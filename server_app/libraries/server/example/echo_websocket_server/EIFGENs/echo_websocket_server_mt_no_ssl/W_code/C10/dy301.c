...
extern void F301_3149(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F301_3151(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F301_3152(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F301_3156(EIF_REFERENCE);
...
void F301_3149 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 300, Current, 1, 1, 5547);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	if (tb1) {
		RTHOOK(4);
		ur8_1 = arg1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2589, dtype))(Current, ur8_1x);
	} else {
		RTHOOK(5);
		...
		if (tb1) {
			...
			RTHOOK(7);
			ur8_1 = arg1;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2591, dtype))(Current, ur8_1x);
			RTHOOK(8);
...
void F301_3151 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
body:;
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(7);
		tr8_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1418, "item", arg1))(arg1)).it_r8);
		ur8_1 = tr8_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2590, dtype))(Current, ur8_1x);
		RTHOOK(8);
...
void F301_3152 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
void F301_3156 (EIF_REFERENCE Current)
{
	GTCX
