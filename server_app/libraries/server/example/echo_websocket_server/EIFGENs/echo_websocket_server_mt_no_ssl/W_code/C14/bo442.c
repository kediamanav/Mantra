...
extern EIF_TYPED_VALUE F442_1559(EIF_REFERENCE);
extern void F442_5517(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F442_1559 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 441, Current, 0, 0, 1901);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(441, Current, 1901);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F442_5517 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 441, Current, 0, 5516);
	RTSA(dtype);
	RTME(dtype, 0);
