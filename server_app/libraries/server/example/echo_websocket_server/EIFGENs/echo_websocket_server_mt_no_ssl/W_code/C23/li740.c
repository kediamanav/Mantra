...
extern void F740_1769(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F740_1770(EIF_REFERENCE);
extern EIF_TYPED_VALUE F740_1771(EIF_REFERENCE);
extern EIF_TYPED_VALUE F740_1772(EIF_REFERENCE);
extern void F740_5524(EIF_REFERENCE, int);
...
void F740_1769 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define arg3 arg3x.it_b
	...
	RTEAA(l_feature_name, 739, Current, 0, 3, 2308);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(739, Current, 2308);
	RTCC(arg1, 739, l_feature_name, 1, RTWCT(1554, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 1554, 0xF80002E2, 0); /* active */
...
EIF_TYPED_VALUE F740_1770 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F740_1771 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F740_1772 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
void F740_5524 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 739, Current, 0, 5523);
	RTSA(dtype);
	RTME(dtype, 0);
