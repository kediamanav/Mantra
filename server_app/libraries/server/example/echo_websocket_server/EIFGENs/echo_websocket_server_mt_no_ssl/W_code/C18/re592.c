...
extern EIF_TYPED_VALUE F592_1561(EIF_REFERENCE);
extern EIF_TYPED_VALUE F592_1562(EIF_REFERENCE);
extern EIF_TYPED_VALUE F592_1563(EIF_REFERENCE);
extern EIF_TYPED_VALUE F592_1564(EIF_REFERENCE);
extern void F592_1565(EIF_REFERENCE);
extern void F592_5518(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F592_1561 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F592_1562 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 591, Current, 0, 0, 1968);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(591, Current, 1968);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F592_1564 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 591, Current, 0, 0, 1969);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(591, Current, 1969);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F592_1565 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 591, Current, 0, 0, 1970);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(591, Current, 1970);
	RTIV(Current, RTAL);
...
void F592_5518 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 591, Current, 0, 5517);
	RTSA(dtype);
	RTME(dtype, 0);
