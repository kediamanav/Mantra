...
extern EIF_TYPED_VALUE F467_1517(EIF_REFERENCE);
extern EIF_TYPED_VALUE F467_1518(EIF_REFERENCE);
extern EIF_TYPED_VALUE F467_1519(EIF_REFERENCE);
extern void F467_1520(EIF_REFERENCE);
extern void F467_1521(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F467_1517 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 466, Current, 0, 0, 1587);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(466, Current, 1587);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F467_1518 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F467_1519 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 466, Current, 0, 0, 1584);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(466, Current, 1584);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F467_1520 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 466, Current, 0, 0, 1585);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(466, Current, 1585);
	RTIV(Current, RTAL);
...
void F467_1521 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 466, Current, 0, 0, 1586);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(466, Current, 1586);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
