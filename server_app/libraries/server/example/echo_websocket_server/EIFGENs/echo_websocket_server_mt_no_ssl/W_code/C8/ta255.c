...
extern void F255_1589(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {TABLE}.bag_put */
void F255_1589 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 254, Current, 0, 1, 2026);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(254, Current, 2026);
	RTCC(arg1, 254, l_feature_name, 1, RTWCT(1370, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
