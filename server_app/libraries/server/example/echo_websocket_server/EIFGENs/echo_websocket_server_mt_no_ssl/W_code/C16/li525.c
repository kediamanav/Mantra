...
extern EIF_TYPED_VALUE F525_3145(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F525_3146(EIF_REFERENCE);
extern EIF_TYPED_VALUE F525_3147(EIF_REFERENCE);
extern void F525_5538(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F525_3145 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 524, Current, 2, 1, 5519);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(524, Current, 5519);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tu4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1418, "item", arg1))(arg1)).it_n4);
...
/* {LIST}.after */
EIF_TYPED_VALUE F525_3146 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 524, Current, 0, 0, 5520);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(524, Current, 5520);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F525_3147 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 524, Current, 0, 0, 5521);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(524, Current, 5521);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F525_5538 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 524, Current, 0, 5537);
	RTSA(dtype);
	RTME(dtype, 0);
