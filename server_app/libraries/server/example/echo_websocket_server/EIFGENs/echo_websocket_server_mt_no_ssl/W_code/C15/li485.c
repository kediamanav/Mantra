...
extern EIF_TYPED_VALUE F485_3145(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F485_3146(EIF_REFERENCE);
extern EIF_TYPED_VALUE F485_3147(EIF_REFERENCE);
extern void F485_5538(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F485_3145 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 484, Current, 2, 1, 5515);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(484, Current, 5515);
	RTCC(arg1, 484, l_feature_name, 1, eif_attached_type(Dftype(Current)));
	RTIV(Current, RTAL);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tp2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1418, "item", arg1))(arg1)).it_p);
...
/* {LIST}.after */
EIF_TYPED_VALUE F485_3146 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 484, Current, 0, 0, 5516);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(484, Current, 5516);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F485_3147 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 484, Current, 0, 0, 5517);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(484, Current, 5517);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F485_5538 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 484, Current, 0, 5537);
	RTSA(dtype);
	RTME(dtype, 0);
