...
extern void F583_3149(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F583_3151(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F583_3152(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F583_3156(EIF_REFERENCE);
...
void F583_3149 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uw1 uw1x.it_c4
	...
	RTEAA(l_feature_name, 582, Current, 1, 1, 5575);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(582, Current, 5575);
	RTIV(Current, RTAL);
...
body:;
	...
	if (tb1) {
		RTHOOK(4);
		uw1 = arg1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2589, dtype))(Current, uw1x);
	} else {
		RTHOOK(5);
		...
		if (tb1) {
			...
			RTHOOK(7);
			uw1 = arg1;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2591, dtype))(Current, uw1x);
			RTHOOK(8);
...
void F583_3151 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uw1 uw1x.it_c4
	...
	RTEAA(l_feature_name, 582, Current, 0, 1, 5576);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(582, Current, 5576);
	RTCC(arg1, 582, l_feature_name, 1, eif_attached_type(Dftype(Current)));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("extendible", EX_PRE);
...
body:;
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(7);
		tw1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1418, "item", arg1))(arg1)).it_c4);
		uw1 = tw1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2590, dtype))(Current, uw1x);
		RTHOOK(8);
...
void F583_3152 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uw1 uw1x.it_c4
	...
	RTEAA(l_feature_name, 582, Current, 0, 1, 5577);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(582, Current, 5577);
	RTCC(arg1, 582, l_feature_name, 1, eif_attached_type(Dftype(Current)));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F583_3156 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 582, Current, 0, 0, 5578);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(582, Current, 5578);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
