...
extern void F788_6514(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F788_6515(EIF_REFERENCE);
...
void F788_6515 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui8_1 ui8_1x.it_i8
	...
	RTEAA(l_feature_name, 787, Current, 2, 0, 12040);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(787, Current, 12040);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	for (;;) {
		...
		RTNHOOK(4,1);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(5009, "write_input_stream", tr1))(tr1);
		RTHOOK(5);
		tb1 = *(EIF_BOOLEAN *)(Current + RTWA(5049, dtype));
		if (tb1) {
			RTHOOK(6);
			...
			tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5048, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			RTNHOOK(7,1);
			ti4_1 = *(EIF_INTEGER_32 *)(tr1 + RTVA(5008, "last_input_bytes", tr1));
