...
extern EIF_TYPED_VALUE F513_1593(EIF_REFERENCE);
extern void F513_5519(EIF_REFERENCE, int);
...
/* {ACTIVE}.replaceable */
EIF_TYPED_VALUE F513_1593 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 512, Current, 0, 0, 2055);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(512, Current, 2055);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {ACTIVE}._invariant */
void F513_5519 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 512, Current, 0, 5518);
	RTSA(dtype);
	RTME(dtype, 0);
