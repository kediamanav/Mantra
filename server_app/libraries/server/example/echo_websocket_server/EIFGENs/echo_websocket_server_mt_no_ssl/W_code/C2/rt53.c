...
extern void F53_980(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F53_981(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F53_980 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 52, Current, 0, 1, 1033);
	RTSA(Dtype(Current));
	RTSC;
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWC(3726, Dtype(tr1)))(tr1, uc1x, ui4_1x);
	RTNHOOK(1,3);
	ur1 = RTCCL(tr1);
...
void F53_981 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 52, Current, 0, 1, 1034);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(52, Current, 1034);
	RTCC(arg1, 52, l_feature_name, 1, eif_attached_type(218));
	RTIV(Current, RTAL);
