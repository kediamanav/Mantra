...
extern EIF_TYPED_VALUE F353_3145(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F353_3146(EIF_REFERENCE);
extern EIF_TYPED_VALUE F353_3147(EIF_REFERENCE);
extern void F353_5538(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F353_3145 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 352, Current, 2, 1, 5503);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(352, Current, 5503);
	RTCC(arg1, 352, l_feature_name, 1, eif_attached_type(Dftype(Current)));
	RTIV(Current, RTAL);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tu8_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1418, "item", arg1))(arg1)).it_n8);
...
/* {LIST}.after */
EIF_TYPED_VALUE F353_3146 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 352, Current, 0, 0, 5504);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(352, Current, 5504);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F353_3147 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 352, Current, 0, 0, 5505);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(352, Current, 5505);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1380, Dtype(Current)))(Current)).it_i4);
...
/* {LIST}._invariant */
void F353_5538 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 352, Current, 0, 5537);
	RTSA(dtype);
	RTME(dtype, 0);
