...
extern EIF_TYPED_VALUE F661_1517(EIF_REFERENCE);
extern EIF_TYPED_VALUE F661_1518(EIF_REFERENCE);
extern EIF_TYPED_VALUE F661_1519(EIF_REFERENCE);
extern void F661_1520(EIF_REFERENCE);
extern void F661_1521(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F661_1517 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 660, Current, 0, 0, 1607);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(660, Current, 1607);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F661_1518 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F661_1519 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 660, Current, 0, 0, 1604);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(660, Current, 1604);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F661_1520 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 660, Current, 0, 0, 1605);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(660, Current, 1605);
	RTIV(Current, RTAL);
...
void F661_1521 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 660, Current, 0, 0, 1606);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(660, Current, 1606);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
