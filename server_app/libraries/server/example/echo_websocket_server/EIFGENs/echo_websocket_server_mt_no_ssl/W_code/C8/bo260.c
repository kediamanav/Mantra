...
extern EIF_TYPED_VALUE F260_1559(EIF_REFERENCE);
extern void F260_5517(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F260_1559 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 259, Current, 0, 0, 1893);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(259, Current, 1893);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F260_5517 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 259, Current, 0, 5516);
	RTSA(dtype);
	RTME(dtype, 0);
