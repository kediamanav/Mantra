...
extern EIF_TYPED_VALUE F694_1517(EIF_REFERENCE);
extern EIF_TYPED_VALUE F694_1518(EIF_REFERENCE);
extern EIF_TYPED_VALUE F694_1519(EIF_REFERENCE);
extern void F694_1520(EIF_REFERENCE);
extern void F694_1521(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F694_1517 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 693, Current, 0, 0, 1612);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(693, Current, 1612);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F694_1518 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F694_1519 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 693, Current, 0, 0, 1609);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(693, Current, 1609);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F694_1520 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 693, Current, 0, 0, 1610);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(693, Current, 1610);
	RTIV(Current, RTAL);
...
void F694_1521 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 693, Current, 0, 0, 1611);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(693, Current, 1611);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
