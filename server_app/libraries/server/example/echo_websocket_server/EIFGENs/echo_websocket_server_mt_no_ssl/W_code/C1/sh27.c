...
extern EIF_TYPED_VALUE F27_582(EIF_REFERENCE);
...
RTOID (F27_582)
EIF_TYPED_VALUE F27_582 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 26, Current, 0, 0, 645);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(26, Current, 645);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
