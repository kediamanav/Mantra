...
extern EIF_TYPED_VALUE F157_2836(EIF_REFERENCE);
...
EIF_TYPED_VALUE F157_2836 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 156, Current, 0, 0, 3366);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(156, Current, 3366);
	RTIV(Current, RTAL);
	RTHOOK(1);
