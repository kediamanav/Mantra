...
extern EIF_TYPED_VALUE F663_1593(EIF_REFERENCE);
extern void F663_5519(EIF_REFERENCE, int);
...
/* {ACTIVE}.replaceable */
EIF_TYPED_VALUE F663_1593 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 662, Current, 0, 0, 2061);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(662, Current, 2061);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {ACTIVE}._invariant */
void F663_5519 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 662, Current, 0, 5518);
	RTSA(dtype);
	RTME(dtype, 0);
