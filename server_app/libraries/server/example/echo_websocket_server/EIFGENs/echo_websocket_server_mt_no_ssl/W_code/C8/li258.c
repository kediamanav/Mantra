...
extern EIF_TYPED_VALUE F258_3145(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F258_3146(EIF_REFERENCE);
extern EIF_TYPED_VALUE F258_3147(EIF_REFERENCE);
extern void F258_5538(EIF_REFERENCE, int);
...
/* {LIST}.after */
EIF_TYPED_VALUE F258_3146 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 257, Current, 0, 0, 5496);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(257, Current, 5496);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F258_3147 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 257, Current, 0, 0, 5497);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(257, Current, 5497);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F258_5538 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 257, Current, 0, 5537);
	RTSA(dtype);
	RTME(dtype, 0);
