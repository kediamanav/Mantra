...
extern EIF_TYPED_VALUE F339_1517(EIF_REFERENCE);
extern EIF_TYPED_VALUE F339_1518(EIF_REFERENCE);
extern EIF_TYPED_VALUE F339_1519(EIF_REFERENCE);
extern void F339_1520(EIF_REFERENCE);
extern void F339_1521(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F339_1517 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 338, Current, 0, 0, 1572);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(338, Current, 1572);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F339_1518 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F339_1519 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 338, Current, 0, 0, 1569);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(338, Current, 1569);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F339_1520 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 338, Current, 0, 0, 1570);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(338, Current, 1570);
	RTIV(Current, RTAL);
...
void F339_1521 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 338, Current, 0, 0, 1571);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(338, Current, 1571);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
