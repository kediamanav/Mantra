...
extern EIF_TYPED_VALUE F527_1559(EIF_REFERENCE);
extern void F527_5517(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F527_1559 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 526, Current, 0, 0, 1905);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(526, Current, 1905);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F527_5517 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 526, Current, 0, 5516);
	RTSA(dtype);
	RTME(dtype, 0);
