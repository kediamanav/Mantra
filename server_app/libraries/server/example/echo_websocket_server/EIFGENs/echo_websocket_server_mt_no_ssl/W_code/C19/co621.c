...
extern EIF_TYPED_VALUE F621_1517(EIF_REFERENCE);
extern EIF_TYPED_VALUE F621_1518(EIF_REFERENCE);
extern EIF_TYPED_VALUE F621_1519(EIF_REFERENCE);
extern void F621_1520(EIF_REFERENCE);
extern void F621_1521(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F621_1517 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 620, Current, 0, 0, 1602);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(620, Current, 1602);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F621_1518 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F621_1519 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 620, Current, 0, 0, 1599);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(620, Current, 1599);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F621_1520 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 620, Current, 0, 0, 1600);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(620, Current, 1600);
	RTIV(Current, RTAL);
...
void F621_1521 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 620, Current, 0, 0, 1601);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(620, Current, 1601);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
