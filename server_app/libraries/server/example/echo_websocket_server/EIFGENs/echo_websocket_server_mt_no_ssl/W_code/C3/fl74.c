...
extern EIF_TYPED_VALUE F74_1235(EIF_REFERENCE);
...
EIF_TYPED_VALUE F74_1234 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 73, Current, 0, 0, 1274);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(73, Current, 1274);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(673, 38))(Current)).it_i4);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 73, Current, 0, 0, 1275);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
