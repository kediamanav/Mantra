...
extern EIF_TYPED_VALUE F374_3131(EIF_REFERENCE);
extern EIF_TYPED_VALUE F374_3132(EIF_REFERENCE);
extern void F374_3138(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F374_3141(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F374_3142(EIF_REFERENCE);
extern EIF_TYPED_VALUE F374_3143(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F374_3131 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 373, Current, 0, 0, 5441);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(373, Current, 5441);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F374_3132 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 373, Current, 0, 0, 5442);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(373, Current, 5442);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {DYNAMIC_CHAIN}.prune */
void F374_3138 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 373, Current, 0, 1, 5443);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(373, Current, 5443);
	RTIV(Current, RTAL);
...
void F374_3141 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 373, Current, 0, 1, 5444);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(373, Current, 5444);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F374_3142 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 373, Current, 0, 0, 5445);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(373, Current, 5445);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F374_3143 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 373, Current, 2, 1, 5446);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(373, Current, 5446);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
