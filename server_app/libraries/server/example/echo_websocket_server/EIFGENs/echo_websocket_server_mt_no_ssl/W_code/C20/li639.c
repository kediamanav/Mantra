...
extern EIF_TYPED_VALUE F639_3145(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F639_3146(EIF_REFERENCE);
extern EIF_TYPED_VALUE F639_3147(EIF_REFERENCE);
extern void F639_5538(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F639_3145 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 638, Current, 2, 1, 5531);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(638, Current, 5531);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tr4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1418, "item", arg1))(arg1)).it_r4);
...
/* {LIST}.after */
EIF_TYPED_VALUE F639_3146 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 638, Current, 0, 0, 5532);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(638, Current, 5532);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F639_3147 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 638, Current, 0, 0, 5533);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(638, Current, 5533);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F639_5538 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 638, Current, 0, 5537);
	RTSA(dtype);
	RTME(dtype, 0);
