...
extern EIF_TYPED_VALUE F593_1559(EIF_REFERENCE);
extern void F593_5517(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F593_1559 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 592, Current, 0, 0, 1909);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(592, Current, 1909);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F593_5517 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 592, Current, 0, 5516);
	RTSA(dtype);
	RTME(dtype, 0);
