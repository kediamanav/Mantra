...
extern EIF_TYPED_VALUE F249_3131(EIF_REFERENCE);
extern EIF_TYPED_VALUE F249_3132(EIF_REFERENCE);
extern void F249_3138(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F249_3141(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F249_3142(EIF_REFERENCE);
extern EIF_TYPED_VALUE F249_3143(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F249_3131 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 248, Current, 0, 0, 5423);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(248, Current, 5423);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F249_3132 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 248, Current, 0, 0, 5424);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(248, Current, 5424);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {DYNAMIC_CHAIN}.prune */
void F249_3138 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 248, Current, 0, 1, 5425);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(248, Current, 5425);
	RTCC(arg1, 248, l_feature_name, 1, RTWCT(1418, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
...
void F249_3141 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 248, Current, 0, 1, 5426);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(248, Current, 5426);
	RTCC(arg1, 248, l_feature_name, 1, RTWCT(1418, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F249_3142 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 248, Current, 0, 0, 5427);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(248, Current, 5427);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F249_3143 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 248, Current, 2, 1, 5428);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(248, Current, 5428);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
