...
extern EIF_TYPED_VALUE F311_1635(EIF_REFERENCE);
extern void F311_5686(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F311_1635 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 310, Current, 0, 0, 1950);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(310, Current, 1950);
	RTIV(Current, RTAL);
	RTHOOK(1);
