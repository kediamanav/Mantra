...
extern EIF_TYPED_VALUE F487_3087(EIF_REFERENCE);
...
EIF_TYPED_VALUE F487_3087 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 486, Current, 0, 0, 3911);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(486, Current, 3911);
	RTIV(Current, RTAL);
	RTHOOK(1);
