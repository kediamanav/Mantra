...
extern EIF_TYPED_VALUE F263_1637(EIF_REFERENCE);
extern void F263_5687(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F263_1637 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 262, Current, 0, 0, 1972);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(262, Current, 1972);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F263_5687 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 262, Current, 0, 5686);
	RTSA(dtype);
	RTME(dtype, 0);
