...
extern EIF_TYPED_VALUE F302_3087(EIF_REFERENCE);
...
EIF_TYPED_VALUE F302_3087 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 301, Current, 0, 0, 3905);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(301, Current, 3905);
	RTIV(Current, RTAL);
	RTHOOK(1);
