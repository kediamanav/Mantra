...
extern EIF_TYPED_VALUE F293_1595(EIF_REFERENCE);
extern EIF_TYPED_VALUE F293_1596(EIF_REFERENCE);
extern EIF_TYPED_VALUE F293_1597(EIF_REFERENCE);
extern void F293_1598(EIF_REFERENCE);
extern void F293_1599(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F293_1595 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 292, Current, 0, 0, 1637);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(292, Current, 1637);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F293_1596 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F293_1597 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 292, Current, 0, 0, 1639);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(292, Current, 1639);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F293_1598 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 292, Current, 0, 0, 1640);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(292, Current, 1640);
	RTIV(Current, RTAL);
...
void F293_1599 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 292, Current, 0, 0, 1641);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(292, Current, 1641);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
