...
static EIF_TYPE_INDEX gen_type0_110 [] = {242,109,0xFFFF};
...
static struct desc_info desc_110[] = {
	...
	{1, (BODY_INDEX)-1, 242, gen_type0_110},
...
void Init110(void)
{
	...
	IDSC(desc_110 + 34, 117, 109);
	IDSC(desc_110 + 35, 30, 109);
}
