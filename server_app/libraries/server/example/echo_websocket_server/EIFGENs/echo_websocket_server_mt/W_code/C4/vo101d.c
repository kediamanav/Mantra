...
static EIF_TYPE_INDEX gen_type0_101 [] = {242,100,0xFFFF};
...
static struct desc_info desc_101[] = {
	...
	{1, (BODY_INDEX)-1, 242, gen_type0_101},
...
void Init101(void)
{
	...
	IDSC(desc_101 + 34, 117, 100);
	IDSC(desc_101 + 35, 30, 100);
}
