...
extern EIF_TYPED_VALUE F580_3285(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F580_3286(EIF_REFERENCE);
extern EIF_TYPED_VALUE F580_3287(EIF_REFERENCE);
extern void F580_5708(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F580_3285 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 579, Current, 2, 1, 5670);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(579, Current, 5670);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tu2_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1489, "item", arg1))(arg1)).it_n2);
...
/* {LIST}.after */
EIF_TYPED_VALUE F580_3286 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 579, Current, 0, 0, 5667);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(579, Current, 5667);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F580_3287 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 579, Current, 0, 0, 5668);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(579, Current, 5668);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F580_5708 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 579, Current, 0, 5707);
	RTSA(dtype);
	RTME(dtype, 0);
