...
extern EIF_TYPED_VALUE F390_1595(EIF_REFERENCE);
extern EIF_TYPED_VALUE F390_1596(EIF_REFERENCE);
extern EIF_TYPED_VALUE F390_1597(EIF_REFERENCE);
extern void F390_1598(EIF_REFERENCE);
extern void F390_1599(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F390_1595 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 389, Current, 0, 0, 1657);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(389, Current, 1657);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F390_1596 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F390_1597 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 389, Current, 0, 0, 1659);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(389, Current, 1659);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F390_1598 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 389, Current, 0, 0, 1660);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(389, Current, 1660);
	RTIV(Current, RTAL);
...
void F390_1599 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 389, Current, 0, 0, 1661);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(389, Current, 1661);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
