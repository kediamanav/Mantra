...
extern EIF_TYPED_VALUE F522_1637(EIF_REFERENCE);
extern void F522_5687(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F522_1637 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 521, Current, 0, 0, 1986);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(521, Current, 1986);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F522_5687 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 521, Current, 0, 5686);
	RTSA(dtype);
	RTME(dtype, 0);
