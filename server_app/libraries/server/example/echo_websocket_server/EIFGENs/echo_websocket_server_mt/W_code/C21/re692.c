...
extern EIF_TYPED_VALUE F692_3087(EIF_REFERENCE);
...
EIF_TYPED_VALUE F692_3087 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 691, Current, 0, 0, 3914);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(691, Current, 3914);
	RTIV(Current, RTAL);
	RTHOOK(1);
