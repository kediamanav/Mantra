...
static EIF_TYPE_INDEX gen_type0_102 [] = {242,101,0xFFFF};
...
static struct desc_info desc_102[] = {
	...
	{1, (BODY_INDEX)-1, 242, gen_type0_102},
...
void Init102(void)
{
	...
	IDSC(desc_102 + 34, 117, 101);
	IDSC(desc_102 + 35, 30, 101);
}
