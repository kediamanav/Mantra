...
extern EIF_TYPED_VALUE F320_3087(EIF_REFERENCE);
...
EIF_TYPED_VALUE F320_3087 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 319, Current, 0, 0, 3906);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(319, Current, 3906);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF800013C, 0,0); /* Result */
	
	{
		EIF_TYPE_INDEX typarr0[] = {316,0,0xFFFF};
