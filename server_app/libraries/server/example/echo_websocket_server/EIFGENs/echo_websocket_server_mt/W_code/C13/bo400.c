...
extern EIF_TYPED_VALUE F400_1637(EIF_REFERENCE);
extern void F400_5687(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F400_1637 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 399, Current, 0, 0, 1978);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(399, Current, 1978);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F400_5687 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 399, Current, 0, 5686);
	RTSA(dtype);
	RTME(dtype, 0);
