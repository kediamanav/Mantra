...
extern EIF_TYPED_VALUE F605_3087(EIF_REFERENCE);
...
EIF_TYPED_VALUE F605_3087 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 604, Current, 0, 0, 3913);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(604, Current, 3913);
	RTIV(Current, RTAL);
	RTHOOK(1);
