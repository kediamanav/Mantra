...
extern EIF_TYPED_VALUE F87_1343(EIF_REFERENCE);
extern EIF_TYPED_VALUE F87_1344(EIF_REFERENCE);
...
EIF_TYPED_VALUE F87_1343 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 86, Current, 0, 0, 1383);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(86, Current, 1383);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(693, 40))(Current)).it_i4);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 86, Current, 0, 0, 1384);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(86, Current, 1384);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
