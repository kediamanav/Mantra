...
extern void F260_1667(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {TABLE}.bag_put */
void F260_1667 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 259, Current, 0, 1, 2104);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(259, Current, 2104);
	RTCC(arg1, 259, l_feature_name, 1, RTWCT(1441, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
