...
extern EIF_TYPED_VALUE F447_3087(EIF_REFERENCE);
...
EIF_TYPED_VALUE F447_3087 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 446, Current, 0, 0, 3910);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(446, Current, 3910);
	RTIV(Current, RTAL);
	RTHOOK(1);
