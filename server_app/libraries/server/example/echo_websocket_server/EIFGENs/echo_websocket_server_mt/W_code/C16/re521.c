...
extern EIF_TYPED_VALUE F521_1639(EIF_REFERENCE);
extern EIF_TYPED_VALUE F521_1640(EIF_REFERENCE);
extern EIF_TYPED_VALUE F521_1641(EIF_REFERENCE);
extern EIF_TYPED_VALUE F521_1642(EIF_REFERENCE);
extern void F521_1643(EIF_REFERENCE);
extern void F521_5688(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F521_1639 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F521_1640 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F521_1641 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 520, Current, 0, 0, 2041);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(520, Current, 2041);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F521_1642 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 520, Current, 0, 0, 2042);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(520, Current, 2042);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F521_5688 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 520, Current, 0, 5687);
	RTSA(dtype);
	RTME(dtype, 0);
