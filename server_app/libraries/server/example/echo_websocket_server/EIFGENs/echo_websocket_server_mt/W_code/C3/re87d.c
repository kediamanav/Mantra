...
static EIF_TYPE_INDEX gen_type0_87 [] = {242,86,0xFFFF};
...
static struct desc_info desc_87[] = {
	...
	{1, (BODY_INDEX)-1, 242, gen_type0_87},
...
void Init87(void)
{
	IDSC(desc_87, 0, 86);
	IDSC(desc_87 + 1, 2, 86);
	IDSC(desc_87 + 34, 117, 86);
	IDSC(desc_87 + 35, 30, 86);
}
