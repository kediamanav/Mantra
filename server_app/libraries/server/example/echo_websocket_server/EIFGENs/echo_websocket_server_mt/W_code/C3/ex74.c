...
extern EIF_TYPED_VALUE F74_1252(EIF_REFERENCE);
...
RTOID (F74_1252)
EIF_TYPED_VALUE F74_1252 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 73, Current, 0, 0, 1292);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(73, Current, 1292);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
