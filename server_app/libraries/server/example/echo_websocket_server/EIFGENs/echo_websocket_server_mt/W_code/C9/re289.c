...
extern EIF_TYPED_VALUE F289_3087(EIF_REFERENCE);
...
EIF_TYPED_VALUE F289_3087 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 288, Current, 0, 0, 3904);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(288, Current, 3904);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF800011D, 0,0); /* Result */
	
	{
		EIF_TYPE_INDEX typarr0[] = {285,0,0xFFFF};
