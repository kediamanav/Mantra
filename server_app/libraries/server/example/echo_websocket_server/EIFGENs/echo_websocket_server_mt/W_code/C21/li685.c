...
extern EIF_TYPED_VALUE F685_750(EIF_REFERENCE);
extern void F685_751(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F685_752(EIF_REFERENCE);
...
/* {LINKABLE}.right */
EIF_TYPED_VALUE F685_750 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
/* {LINKABLE}.put_right */
void F685_751 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 684, Current, 0, 1, 819);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(684, Current, 819);
	RTCC(arg1, 684, l_feature_name, 1, Dftype(Current));
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 715, 0xF80002AC, 0); /* right */
...
void F685_752 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 684, Current, 0, 0, 820);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(684, Current, 820);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 715, 0xF80002AC, 0); /* right */
