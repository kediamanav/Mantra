...
extern void F365_1667(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {TABLE}.bag_put */
void F365_1667 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 364, Current, 0, 1, 2108);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(364, Current, 2108);
	RTCC(arg1, 364, l_feature_name, 1, RTWCT(1441, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
