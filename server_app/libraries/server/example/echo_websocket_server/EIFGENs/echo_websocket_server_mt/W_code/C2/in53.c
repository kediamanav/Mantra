...
extern EIF_TYPED_VALUE F53_890(EIF_REFERENCE);
extern void F53_891(EIF_REFERENCE, EIF_TYPED_VALUE);extern void en_local_host_name(EIF_POINTER);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 52, Current, 0, 0, 954);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(52, Current, 954);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 52, Current, 0, 0, 955);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
void F53_891 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
