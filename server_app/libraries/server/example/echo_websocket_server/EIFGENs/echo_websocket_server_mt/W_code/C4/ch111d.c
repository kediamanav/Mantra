...
static EIF_TYPE_INDEX gen_type0_111 [] = {242,110,0xFFFF};
...
static struct desc_info desc_111[] = {
	...
	{1, (BODY_INDEX)-1, 242, gen_type0_111},
...
void Init111(void)
{
	...
	IDSC(desc_111 + 34, 117, 110);
	IDSC(desc_111 + 35, 30, 110);
}
