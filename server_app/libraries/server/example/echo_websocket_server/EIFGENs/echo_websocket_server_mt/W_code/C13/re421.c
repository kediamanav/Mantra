...
extern EIF_TYPED_VALUE F421_3087(EIF_REFERENCE);
...
EIF_TYPED_VALUE F421_3087 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 420, Current, 0, 0, 3909);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(420, Current, 3909);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80001A1, 0,0); /* Result */
	
	{
		EIF_TYPE_INDEX typarr0[] = {417,0,0xFFFF};
