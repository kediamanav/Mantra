...
extern EIF_TYPED_VALUE F255_1595(EIF_REFERENCE);
extern EIF_TYPED_VALUE F255_1596(EIF_REFERENCE);
extern EIF_TYPED_VALUE F255_1597(EIF_REFERENCE);
extern void F255_1598(EIF_REFERENCE);
extern void F255_1599(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F255_1595 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 254, Current, 0, 0, 1632);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(254, Current, 1632);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F255_1596 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F255_1597 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 254, Current, 0, 0, 1634);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(254, Current, 1634);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F255_1598 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 254, Current, 0, 0, 1635);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(254, Current, 1635);
	RTIV(Current, RTAL);
...
void F255_1599 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 254, Current, 0, 0, 1636);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(254, Current, 1636);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
