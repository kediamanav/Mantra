...
EIF_TYPED_VALUE F77_1310 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 76, Current, 0, 0, 1350);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(76, Current, 1350);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(701, 40))(Current)).it_i4);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 76, Current, 0, 0, 1351);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
