...
extern EIF_TYPED_VALUE F386_3087(EIF_REFERENCE);
...
EIF_TYPED_VALUE F386_3087 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 385, Current, 0, 0, 3908);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(385, Current, 3908);
	RTIV(Current, RTAL);
	RTHOOK(1);
