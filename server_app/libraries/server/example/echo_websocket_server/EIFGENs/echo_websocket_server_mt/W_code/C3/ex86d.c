...
static EIF_TYPE_INDEX gen_type0_86 [] = {242,85,0xFFFF};
...
static struct desc_info desc_86[] = {
	...
	{1, (BODY_INDEX)-1, 242, gen_type0_86},
...
void Init86(void)
{
	IDSC(desc_86, 0, 85);
	IDSC(desc_86 + 1, 2, 85);
	IDSC(desc_86 + 34, 117, 85);
	IDSC(desc_86 + 35, 30, 85);
}
