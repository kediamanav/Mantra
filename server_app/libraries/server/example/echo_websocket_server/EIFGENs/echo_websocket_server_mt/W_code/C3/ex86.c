...
extern EIF_TYPED_VALUE F86_1341(EIF_REFERENCE);
...
EIF_TYPED_VALUE F86_1341 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 85, Current, 0, 0, 1381);
	RTSA(Dtype(Current));
	RTSC;
	...
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(697, 40))(Current)).it_i4);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 85, Current, 0, 0, 1382);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(85, Current, 1382);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
