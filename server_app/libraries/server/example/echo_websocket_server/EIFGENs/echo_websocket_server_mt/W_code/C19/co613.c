...
extern EIF_TYPED_VALUE F613_1595(EIF_REFERENCE);
extern EIF_TYPED_VALUE F613_1596(EIF_REFERENCE);
extern EIF_TYPED_VALUE F613_1597(EIF_REFERENCE);
extern void F613_1598(EIF_REFERENCE);
extern void F613_1599(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F613_1595 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 612, Current, 0, 0, 1682);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(612, Current, 1682);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F613_1596 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F613_1597 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 612, Current, 0, 0, 1684);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(612, Current, 1684);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F613_1598 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 612, Current, 0, 0, 1685);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(612, Current, 1685);
	RTIV(Current, RTAL);
...
void F613_1599 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 612, Current, 0, 0, 1686);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(612, Current, 1686);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
