...
extern EIF_TYPED_VALUE F333_1639(EIF_REFERENCE);
extern EIF_TYPED_VALUE F333_1640(EIF_REFERENCE);
extern EIF_TYPED_VALUE F333_1641(EIF_REFERENCE);
extern EIF_TYPED_VALUE F333_1642(EIF_REFERENCE);
extern void F333_1643(EIF_REFERENCE);
extern void F333_5688(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F333_1639 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F333_1640 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F333_1641 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 332, Current, 0, 0, 2005);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(332, Current, 2005);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F333_1642 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 332, Current, 0, 0, 2006);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(332, Current, 2006);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F333_1643 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 332, Current, 0, 0, 2001);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(332, Current, 2001);
	RTIV(Current, RTAL);
...
void F333_5688 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 332, Current, 0, 5687);
	RTSA(dtype);
	RTME(dtype, 0);
