...
static EIF_TYPE_INDEX gen_type0_129 [] = {242,128,0xFFFF};
...
static struct desc_info desc_129[] = {
	...
	{1, (BODY_INDEX)-1, 242, gen_type0_129},
...
void Init129(void)
{
	...
	IDSC(desc_129 + 34, 196, 128);
	IDSC(desc_129 + 129, 197, 128);
	IDSC(desc_129 + 131, 125, 128);
	IDSC(desc_129 + 158, 198, 128);
}
