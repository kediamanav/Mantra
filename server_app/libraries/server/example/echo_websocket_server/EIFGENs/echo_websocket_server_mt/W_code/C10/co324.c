...
extern EIF_TYPED_VALUE F324_1595(EIF_REFERENCE);
extern EIF_TYPED_VALUE F324_1596(EIF_REFERENCE);
extern EIF_TYPED_VALUE F324_1597(EIF_REFERENCE);
extern void F324_1598(EIF_REFERENCE);
extern void F324_1599(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F324_1595 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 323, Current, 0, 0, 1647);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(323, Current, 1647);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F324_1596 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F324_1597 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 323, Current, 0, 0, 1649);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(323, Current, 1649);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F324_1598 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 323, Current, 0, 0, 1650);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(323, Current, 1650);
	RTIV(Current, RTAL);
...
void F324_1599 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 323, Current, 0, 0, 1651);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(323, Current, 1651);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
