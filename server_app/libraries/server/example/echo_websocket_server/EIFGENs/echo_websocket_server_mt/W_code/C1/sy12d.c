...
static EIF_TYPE_INDEX gen_type0_12 [] = {242,11,0xFFFF};
...
static struct desc_info desc_12[] = {
	{(BODY_INDEX) 294, (BODY_INDEX) -1, INVALID_DTYPE, NULL},
	{0, (BODY_INDEX)-1, 228, NULL},
	{1, (BODY_INDEX)-1, 242, gen_type0_12},
